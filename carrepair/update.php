            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        ...
                        <a href="update.php" class="dropdown-item active">Update Booking</a>
...
<head>
    ...
    <script>
        ...
        function editBooking(bookingID) {
            document.getElementById('editFrame').src = 'edit_booking.php?bookingID=' + bookingID;
        ...
        function deleteBooking(bookingID) {
            if (confirm("Are you sure you want to delete this budget?")) {
                window.location.href = 'delete_booking.php?bookingID=' + bookingID;
            }
        }
    </script>
</head>
    ...
    <?php
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                            <button onclick=\"editBooking(" . $row['bookingID'] . ")\">Edit</button>
