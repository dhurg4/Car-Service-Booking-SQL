                    ...
                    <h1 class="text-white mb-4">Book For A Service</h1>
                        ...
                        <form action="insertBooking.php" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select name="serviceID" class="form-select border-0" style="height: 55px;" required>
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="datetime-local" class="form-control border-0" name="date" required>
                                </div>

                                <div class="col-12">
                                    <textarea name="specialRequest" class="form-control border-0" placeholder="Special Request"></textarea>
                                </div>
                                <div class="col-12">
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-8 col-md-6">
                    ...
                    <p class="mb-0">Contact us ASAP! We will answer any questions you have about our services.</p>
                </div>
